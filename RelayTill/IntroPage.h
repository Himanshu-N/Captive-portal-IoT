...
<head>
    ...
    <style>
        ...
        .loading {
            ...
            width: 60px;
            height: 60px;
            animation: spin 7s linear infinite, fadeOut 7s forwards;
            margin-bottom: 20px;
        }
        @keyframes spin {
            0% {
...
<body>
    <div class="loading-container">
        ...
        <div class="loading-text">Please wait, your IoT LED Control is loading...</div>
    </div>
    <div class="center">
        <div class="container">
    ...
    <div class="credits">Made by Aryan Jadhav & Himanshu Negi</div>
    <script>
        // Redirect after 7 seconds
        setTimeout(function() {
            window.location.href = "/led-onoff";
        }, 7000);
    </script>
</body>
</html>
